...
import com.example.study1.databinding.ActivityRegisterBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnRegister.setOnClickListener { view->
            if(binding.editId.text.isEmpty()||binding.editPw.text.isEmpty()||binding.editPwRe.text.isEmpty()){ // 값이 전부 입력되지 않은경우
                ...
                if(binding.editPw.text.toString().equals(binding.editPwRe.text.toString())){ //패스워드와 패스워드 확인이 일치
